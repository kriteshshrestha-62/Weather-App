...
class _HomeScreensState extends State<HomeScreens> {
  final WeatherServices _weatherModelServices = WeatherServices();
  ...
  Future<void> _getWeather() async {
    ...
    try {
      final weather = await _weatherModelServices.fetchweather(_controller.text);
      setState(() {
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: _weatherModel != null && _weatherModel!.description.toLowerCase().contains('rain')
              ? LinearGradient(colors: [Colors.black, Colors.blue], begin: Alignment.topCenter, end: Alignment.bottomCenter)
              : _weatherModel != null && _weatherModel!.description.toLowerCase().contains('clear')
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: const Color.fromARGB(256, 0, 0, 0),
